            ...
            return (
              ...
              >
                <div className="flex justify-between px-4 py-2">
                  <div className="mb-4">
                    ...
                    <div className="flex mt-4">
                      <div className="me-4">
                        <p className="text-[22px] max-w-[400px] font-semibold">
                          {data?.trip.title}
                        </p>
                  ...
                  <div className="text-right px-8">
                    ...
                    <p className="mb-8">
                      ...
                      {moment(data?.trip.dateTrip).format("DD MMMM YYYY")}
                    </p>
                    {data?.status === "Approve" && (
                      <div className="w-[100px] h-[100px] m-auto">
                        <QRCode
                          className="w-full h-full"
                          value={`Judul : ${data?.trip.title}
                                \nPemesan : ${data?.user.fullname}
                                \nTujuan : ${data?.trip.country.name}
                                \nJumlah Ticket : ${data?.counterQty}
                                \nTanggal : ${data?.trip.dateTrip}
                                \nAkomodasi : ${data?.trip.accomodation}
                                \nTransportation : ${data?.trip.transportation}
                                \nMasa Tinggal : ${data?.trip.day} Hari ${data?.trip.night} Malam
                ...
                <div className="flex pb-2 border-b-2">
                  ...
                  <p className="ms-[120px] text-[18px] font-semibold">
                    Full Name
                  </p>
                  <p className="ms-[140px] text-[18px] font-semibold">Gender</p>
                  <p className="ms-[60px] text-[18px] font-semibold">Phone</p>
                </div>
                <div className="flex py-2 border-b-2 justify-between">
                  <div className="flex">
                    ...
                    <p className=" ms-8 w-[180px] text-[18px]  text-gray-400">
                      {data?.user.fullname}
                    </p>
                    <p className="ms-[45px] w-[70px] text-[18px] text-gray-400">
                      {data?.user.gender}
                    </p>
                    <p className="ms-[50px] text-[18px] text-gray-400">
                      {data?.user.phone}
                    </p>
                  </div>
                  <div className="flex me-[160px]">
                    <p className="ms-[20px] w-[70px] text-[18px]">Qty</p>
